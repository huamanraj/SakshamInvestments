        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2 text-sm">
              <a href="/factor-investing" className="hover:text-white transition-colors duration-200">Factor Investing</a>
              <a href="/mutual-funds" className="hover:text-white transition-colors duration-200">Mutual Funds</a>
              <a href="/fixed-deposits" className="hover:text-white transition-colors duration-200">Fixed Deposits</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2 text-sm">
              <a href="/quiz" className="hover:text-white transition-colors duration-200">Quiz</a>
          ...
          <div className="flex items-start space-x-4">
            <a href="https://www.instagram.com/sakshaminvestments?utm_source=qr&igsh=a2xkc3JvZ3JyY21w" target="_blank" rel="noopener noreferrer" 
